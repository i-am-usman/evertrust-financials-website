      ...
      <main className="mx-auto w-[min(1180px,calc(100%-1.5rem))] mt-8 md:mt-12">
        ...
        <section className="overflow-hidden rounded-[2.5rem] border border-slate-200 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
          <div className="grid gap-0 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
              ...
              <h1 className="font-[Fraunces] text-4xl md:text-6xl leading-[0.95] tracking-[-0.02em] text-slate-900">
            ...
            <div className="relative bg-gradient-to-br from-sky-50 via-white to-teal-50 flex items-center justify-center p-12">
              ...
              <img 
                ...
                className="relative w-full max-w-[280px] h-auto object-contain drop-shadow-[0_20px_40px_rgba(15,23,42,0.15)]" 
              />
            </div>
          </div>
        </section>
        ...
        <section className="mt-16 md:mt-24">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {[
              { name: "Iqra Mirani", role: "Business Dev Rep", bio: "Dedicated to understanding client needs and crafting tailored solutions.", link: "mailto:sales@evertrustfinancials.services", img: "/iqra-mirani.png", icon: Mail },
              { name: "Muhammad Usman", role: "Technical Lead", bio: "Architecting secure infrastructure and custom automation solutions for reliability.", link: "https://www.linkedin.com/in/muhammad-usman-ai-ml/", img: "/PP.jpeg", icon: Linkedin },
              { name: "Hina Batool", role: "Financial Analyst", bio: "Delivering deep financial insight, risk analysis, and strategic forecasting.", link: "mailto:hina@evertrustfinancials.services", img: "/hina-batool.jpg", icon: Mail },
              { name: "Syed Ghulam Hyder", role: "Fractional CFO", bio: "Financial leader specializing in Audit and ERP implementation with PwC experience.", link: "mailto:syed@evertrustfinancials.services", img: "/syed-ghulam.jpeg", icon: Mail }
            ].map((member, i) => (
